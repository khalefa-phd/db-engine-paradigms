...
std::unique_ptr<runtime::Query> q1_hyper(
    runtime::Database& db,
...
std::unique_ptr<runtime::Query> q3_hyper(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency());
std::unique_ptr<runtime::Query> q3_vectorwise(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency(),
    size_t vectorSize = 1024);
...
std::unique_ptr<runtime::Query> q5_hyper(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency());
std::unique_ptr<runtime::Query> q5_vectorwise(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency(),
    size_t vectorSize = 1024);

runtime::Relation q5_no_sel_hyper(runtime::Database& db);
std::unique_ptr<runtime::BlockRelation> q5_no_sel_vectorwise(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency());
...
runtime::Relation q6_hyper(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency());
runtime::Relation q6_vectorwise(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency(),
    size_t vectorSize = 1024);
...
std::unique_ptr<runtime::Query> q9_hyper(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency());
std::unique_ptr<runtime::Query> q9_vectorwise(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency(),
    size_t vectorSize = 1024);
...
struct Q18Builder : public Query, private vectorwise::QueryBuilder {
  ...
  struct Q18 {
    uint64_t zero = 0;
    types::Numeric<12, 2> qty_bound = types::Numeric<12, 2>::castString("300");
    std::unique_ptr<vectorwise::Operator> rootOp;
  };
...
std::unique_ptr<runtime::Query> q18_hyper(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency());
std::unique_ptr<runtime::Query> q18_vectorwise(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency(),
    size_t vectorSize = 1024);
std::unique_ptr<runtime::Query> q18group_vectorwise(
    runtime::Database& db,
    size_t nrThreads = std::thread::hardware_concurrency(),
    size_t vectorSize = 1024);
