...
int main(int argc, char* argv[]) {
  ...
  std::unordered_set<std::string> q = {"1h", "1h1g", "1h1gv", "1h1g4", "1h4"};
  //{"1h", "1v", "3h", "3v", "5h",  "5v",
  //                                   "6h", "6v", "9h", "9v", "18h", "18v"};
  ...
  if (q.count("1h4"))
    e.timeAndProfile(
        "q1 hyper 4", nrTuples(tpch, {"lineitem"}),
        [&]() {
          if (clearCaches) clearOsCaches();
          auto result = q1_hyper_4(tpch, nrThreads);
          escape(&result);
        },
        repetitions);
  ...
  if (q.count("1h0"))
    e.timeAndProfile(
        ...
        [&]() {
          if (clearCaches) clearOsCaches();
          auto result = q1_hyper_0(tpch, nrThreads);
          escape(&result);
        },
        repetitions);
  ...
  if (q.count("1v"))
    e.timeAndProfile(
        "q1 vectorwise", nrTuples(tpch, {"lineitem"}),
        [&]() {
          if (clearCaches) clearOsCaches();
          auto result = q1_vectorwise(tpch, nrThreads, vectorSize);
          escape(&result);
        },
        repetitions);
  ...
  if (q.count("5h"))
    e.timeAndProfile(
        "q5 hyper     ",
        nrTuples(tpch, {"supplier", "region", "nation", "customer", "orders",
                        "lineitem"}),
        [&]() {
          if (clearCaches) clearOsCaches();
  ...
  if (q.count("5v"))
    e.timeAndProfile(
        ...
        [&]() {
          if (clearCaches) clearOsCaches();
          auto result = q5_vectorwise(tpch, nrThreads, vectorSize);
          escape(&result);
        },
        repetitions);
  if (q.count("6h"))
  ...
  if (q.count("6v"))
    e.timeAndProfile(
        "q6 vectorwise", tpch["lineitem"].nrTuples,
        [&]() {
          if (clearCaches) clearOsCaches();
          auto result = q6_vectorwise(tpch, nrThreads, vectorSize);
          escape(&result);
        },
        repetitions);
  if (q.count("9h"))
    e.timeAndProfile(
        "q9 hyper     ",
        nrTuples(tpch, {"nation", "supplier", "part", "partsupp", "lineitem",
                        "orders"}),
        [&]() {
          if (clearCaches) clearOsCaches();
  ...
  if (q.count("9v"))
    e.timeAndProfile(
        ...
        [&]() {
          if (clearCaches) clearOsCaches();
          auto result = q9_vectorwise(tpch, nrThreads, vectorSize);
          escape(&result);
        },
        repetitions);
  if (q.count("18h"))
